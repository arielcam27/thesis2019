...
plt.plot(t, x1Opt1, color='blue', linestyle='solid', linewidth=2, alpha=0.4, label=r"$w_D=10^4, w_R=10^{10}$")
plt.plot(t, x1Opt2, color='blue', linestyle='solid', linewidth=2, alpha=1.0, label=r"$w_D=10^5, w_R=10^{11}$")
...
plt.subplot(2,2,4)
plt.plot(t, uDOpt1/uDMax, color='magenta',  linestyle='solid', marker='+', markevery=200, linewidth=2.5, markersize=10, alpha=0.4, label=r"$u_D, w_D=10^4, w_R=10^{10}$")
plt.plot(t, uROpt1/uRMax, color='orange',    linestyle='solid',  marker='x', markevery=200, linewidth=2.5, markersize=8, alpha=0.4, label=r"$u_R, w_D=10^4, w_R=10^{10}$")
plt.plot(t, uDOpt2/uDMax, color='magenta',  linestyle='solid', marker='+', markevery=200, linewidth=2.5, markersize=10, alpha=1.0, label=r"$u_D, w_D=10^5, w_R=10^{11}$")
plt.plot(t, uROpt2/uRMax, color='orange',    linestyle='solid',  marker='x', markevery=200, linewidth=2.5, markersize=8, alpha=1.0, label=r"$u_R, w_D=10^5, w_R=10^{11}$")leg = plt.legend(loc='top', fancybox=True, framealpha=0.25,fontsize=10)
plt.xlim([0.,T])
plt.ylim([-0.05,1.05])
