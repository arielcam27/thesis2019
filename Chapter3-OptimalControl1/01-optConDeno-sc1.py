...
# Denosumab treatment, Scenario 1
#
# Ariel Camacho
# Doctorate Thesis
...
plt.plot(t, x1Opt1, color='blue', linestyle='solid', linewidth=2, alpha=0.3)
plt.plot(t, x1Opt2, color='blue', linestyle='solid', linewidth=2, alpha=0.6)
plt.plot(t, x1Opt3, color='blue', linestyle='solid', linewidth=2, alpha=1.0)
plt.xlim([0.,T])
...
plt.plot(t, x3Opt1, color='red',  linestyle='solid',  linewidth=2, alpha=0.3, label=r"$\mathsf{w_D=1e6}$")
plt.plot(t, x3Opt2, color='red',  linestyle='solid',  linewidth=2, alpha=0.6, label=r"$\mathsf{w_D=1e7}$")
plt.plot(t, x3Opt3, color='red',  linestyle='solid',  linewidth=2, alpha=1.0, label=r"$\mathsf{w_D=1e8}$")
...
plt.subplot(2,2,4)
plt.plot(t, uDOpt1/uMax, color='black',  linestyle='solid',  linewidth=2, alpha=0.3)
plt.plot(t, uDOpt2/uMax, color='black',  linestyle='solid',  linewidth=2, alpha=0.6)
plt.plot(t, uDOpt3/uMax, color='black',  linestyle='solid',  linewidth=2, alpha=1.0)
plt.xlim([0.,T])
plt.ylim([0., 1.05])
