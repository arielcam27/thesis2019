...
# Bone metastasis model, bifurcation for alpha_T
#
# Ariel Camacho
# Doctorate Thesis
...
PyCont['EQ1'].display((bifPar,'xM'),axes=(2,1,2),stability=True)
#%%
...
PyCont['EQ2'].display((bifPar,'xM'),axes=(2,1,2),stability=True)
#%%
